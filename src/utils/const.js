...
const ENGLISH_INFO_MESSAGE = (year) =>
  `The table shows year ${year} data`;
...
const MORNING_RUN_TITLE = IS_CHINESE ? '' : '';
const MIDDAY_RUN_TITLE = IS_CHINESE ? '' : '';
const AFTERNOON_RUN_TITLE = IS_CHINESE ? '' : '';
const EVENING_RUN_TITLE = IS_CHINESE ? '' : '';
const NIGHT_RUN_TITLE = IS_CHINESE ? '' : '';
